  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-4">No pudimos cargar esta propiedad</h1>
        <p className="text-gray-500 mb-8">Puede ser un problema temporal. Intentá de nuevo o volvé al catálogo.</p>
