...
export const metadata = {
  ...
  description:
    `Te explicamos cómo funciona nuestro tasador: un modelo predictivo apoyado en ${RELEVADAS_PUBLICO} propiedades reales de San Martín de los Andes. Qué mira, por qué te da un rango y no un número mágico, y qué cosas un modelo nunca puede ver.`,
  keywords:
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: `El tasador se apoya en un modelo construido sobre ${RELEVADAS_PUBLICO} propiedades relevadas en San Martín de los Andes. En vez de copiar el precio de un aviso, aprende cómo distintas características —superficie, tipo, ubicación, estado— forman el valor del m² en la zona, y estima cuánto vale una propiedad a partir de ese patrón.`,
      },
    },
    {
      "@type": "Question",
...
const PASOS = [
  {
    ...
    descripcion:
      `Todo arranca con datos. Reunimos y depuramos ${RELEVADAS_PUBLICO} propiedades publicadas y operadas en San Martín de los Andes, descartando avisos duplicados, publicaciones desactualizadas y datos cargados con errores. Sin datos limpios, cualquier estimación es humo.`,
    puntos: [
      `${RELEVADAS_PUBLICO} propiedades relevadas en la ciudad.`,
