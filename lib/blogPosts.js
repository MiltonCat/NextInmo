...
export const blogPosts = [
  {
    id: "cuanto-necesitas-para-comprar-en-san-martin-de-los-andes",
    title: "¿Cuánto necesitás realmente para comprar en San Martín de los Andes?",
    excerpt:
      "El precio del aviso es solo el comienzo: cuánto suman comisión, sellos, escribano e inscripción en Neuquén, cuánto ahorro pide un crédito UVA y cómo validar el precio con el tasador antes de firmar la reserva.",
    category: "Guía de Compra",
    date: "Agosto 2026",
    dateTime: "2026-08-23",
    updated: "2026-08-23",
    readTime: "9 min",
    image: "/tasacion-cuentas.jpg",
    audio: { duracion: "29:38", generado: "2026-08-23" },
  },
  {
