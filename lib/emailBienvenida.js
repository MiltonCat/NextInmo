...
const CONTENIDOS = {
  ...
  invertir: {
    ...
    cuerpo:
      "Analizamos el mercado de San Martín de los Andes con 324 propiedades relevadas. Cuando aparezca una oportunidad con números que cierran, vas a ser de los primeros en saberlo.",
