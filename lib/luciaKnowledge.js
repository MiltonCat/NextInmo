...
const EQUIPO = {
  ...
  limites: "Carolina asesora sobre contratos, documentación y sucesiones de inmuebles. La escritura la otorga un escribano, que es un rol distinto y lo elige la parte compradora. Ninguna respuesta de Lucía reemplaza una consulta profesional sobre un caso concreto.",
};
