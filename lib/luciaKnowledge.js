  ...
  if (tasacion) {
    snippets.push({
      ...
      reglas: [
        ...
        "Los valores del barrio son precios publicados, no de cierre.",
        "El modelo no ve estado, terminaciones, vista, orientación, ruido ni papeles. Decilo por lo que es —el límite del modelo y el motivo real de que Milton lo mire— y no como una disculpa.",
