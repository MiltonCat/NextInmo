...
const CAMPOS =
  "id,created_at,pregunta,answer_id,ruta,respondida,error,fuentes,page_path,model,interno";
...
export const FILTROS = [
  ...
  { value: "prueba", label: "Mis pruebas" },
];
...
export async function getPreguntas({ filtro = "", limite = VENTANA } = {}) {
  ...
  // Las pruebas quedan fuera de TODAS las vistas menos la suya. Si se colaran en
  // "Todas", el conteo por tema mediria cuanto probo Milton y no que pregunta la
  // gente, que es justo para lo que se hizo el panel.
  params.set("interno", filtro === "prueba" ? "is.true" : "is.false");
