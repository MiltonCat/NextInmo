...
const TRACKED_EVENTS = [...CONVERSION_EVENTS, ...RADAR_EVENTS];
...
export async function getAnalyticsOverview(rangeDays) {
  ...
  return { rangeDays, updatedAt: new Date().toISOString(), kpis, series, topPages, channels, devices, conversions, radarFunnel };
}
