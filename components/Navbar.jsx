              ...
              {menuOpen && (
                <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden z-[60]">
                  ...
                  <div className="border-t border-gray-100">
                    {/* Un solo enlace sirve para los dos estados: proxy.js manda a
                        /cuenta/login si no hay sesion, y muestra el panel si la hay.
                        Antes apuntaba a /admin, que no es la cuenta del visitante. */}
                    <Link href="/cuenta"
